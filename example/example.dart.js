// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.10.4.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    jsonEncode(object, toEncodable) {
      return B.C_JsonCodec.encode$2$toEncodable(object, type$.nullable_nullable_Object_Function_nullable_Object._as(toEncodable));
    },
    ...
    Uri_encodeQueryComponent(component, encoding) {
      return A._Uri__uriEncode(1, component, encoding, true);
    },
    ...
    DioException_DioException$connectionTimeout(requestOptions, timeout) {
      return A.DioException$(null, "The request connection took longer than " + timeout.toString$0(0) + " and it was aborted. To get rid of this exception, try raising the RequestOptions.connectTimeout above the duration of " + timeout.toString$0(0) + string$.x20or_im, requestOptions, null, null, B.DioExceptionType_0);
    },
    DioException_DioException$receiveTimeout(requestOptions, timeout) {
      return A.DioException$(null, "The request took longer than " + timeout.toString$0(0) + " to receive data. It was aborted. To get rid of this exception, try raising the RequestOptions.receiveTimeout above the duration of " + timeout.toString$0(0) + string$.x20or_im, requestOptions, null, null, B.DioExceptionType_2);
    },
    ...
    defaultDioExceptionReadableStringBuilder(e) {
      var t1, t2;
      type$.DioException._as(e);
      t1 = "DioException [" + A._DioExceptionTypeExtension_toPrettyDescription(e.type) + "]: " + A.S(e.message);
      t2 = e.error;
      if (t2 != null)
        t1 = t1 + "\n" + ("Error: " + A.S(t2));
      return t1.charCodeAt(0) == 0 ? t1 : t1;
    },
    DioExceptionType: function DioExceptionType(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    ...
    Options$(headers, responseType, validateStatus) {
      return new A.Options(headers, responseType, validateStatus);
    },
    ...
    handleResponseStream(options, response) {
      var receiveStopwatch, t3, _null = null, t1 = {},
        source = response.stream,
        t2 = type$._AsyncStreamController_Uint8List,
        responseSink = new A._AsyncStreamController(_null, _null, _null, _null, t2),
      ...
      t3 = new A.handleResponseStream_stopWatchReceiveTimeout(t1, _null, receiveStopwatch);
      responseSubscription.__late_helper$_value = source.listen$4$cancelOnError$onDone$onError(new A.handleResponseStream_closure(t1, new A.handleResponseStream_watchReceiveTimeout(t1, B.Duration_0, receiveStopwatch, t3, response, responseSubscription, responseSink, options), receiveStopwatch, B.Duration_0, responseSink, options, totalLength), true, new A.handleResponseStream_closure0(t3, responseSubscription, responseSink), new A.handleResponseStream_closure1(t3, responseSink));
      return new A._ControllerStream(responseSink, t2._eval$1("_ControllerStream<1>"));
    },
    ...
    Transformer_urlEncodeQueryMap(map, listFormat) {
      return A.encodeMap(map, new A.Transformer_urlEncodeQueryMap_closure(), true, listFormat);
    },
    ...
    DefaultNullIfEmptyStreamTransformer: function DefaultNullIfEmptyStreamTransformer() {
    },
    DefaultNullIfEmptyStreamTransformer_bind_closure: function DefaultNullIfEmptyStreamTransformer_bind_closure() {
    },
    _DefaultIfEmptyStreamSink: function _DefaultIfEmptyStreamSink(t0) {
      this._outputSink = t0;
      this._hasData = false;
    },
    encodeMap(data, handler, isQuery, listFormat) {
      var leftBracket, rightBracket, t1 = {},
        urlData = new A.StringBuffer("");
      t1.first = true;
      leftBracket = isQuery ? "[" : "%5B";
      rightBracket = isQuery ? "]" : "%5D";
      new A.encodeMap_urlEncode(t1, listFormat, isQuery, new A.encodeMap_maybeEncode(isQuery, A.core_Uri_encodeQueryComponent$closure()), leftBracket, rightBracket, A.core_Uri_encodeQueryComponent$closure(), handler, urlData).call$2(data, "");
    ...
    _extension_0_getResponseHeaders(_this) {
      var headersList, t1, t2, _i, header, splitIdx, key, value, t3,
        headersString = A._asString(_this.getAllResponseHeaders()),
        headers = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.List_String);
      if (headersString.length === 0)
        return headers;
      headersList = headersString.split("\r\n");
      for (t1 = headersList.length, t2 = type$.JSArray_String, _i = 0; _i < t1; ++_i) {
        ...
        t3 = headers.$index(0, key);
        if (t3 == null) {
          t3 = A._setArrayType([], t2);
          headers.$indexSet(0, key, t3);
        }
        J.add$1$ax(t3, value);
      }
      return headers;
    ...
    DioForBrowser$(baseOptions) {
      var t2, t3, t4, _null = null,
        t1 = new A.Interceptors(A._setArrayType([B.C_ImplyContentTypeInterceptor], type$.JSArray_nullable_Interceptor));
      t1.addAll$1(t1, B.List_empty2);
      t1 = new A.DioForBrowser($, t1, $, new A.FusedTransformer(51200), false);
      t2 = type$.String;
      t3 = type$.dynamic;
      t4 = new A.BaseOptions($, $, _null, "GET", false, _null, _null, B.ResponseType_0, A.options___defaultValidateStatus$closure(), true, A.LinkedHashMap_LinkedHashMap$_empty(t2, t3), true, 5, true, _null, _null, B.ListFormat_4);
      t4._RequestConfig$16$contentType$extra$followRedirects$headers$listFormat$maxRedirects$method$persistentConnection$preserveHeaderCase$receiveDataWhenStatusError$receiveTimeout$requestEncoder$responseDecoder$responseType$sendTimeout$validateStatus(_null, _null, _null, _null, _null, _null, _null, _null, false, _null, _null, _null, _null, B.ResponseType_0, _null, _null);
      t4.set$baseUrl("");
      t4.OptionsMixin___OptionsMixin_queryParameters_A = type$.Map_String_dynamic._as(A.LinkedHashMap_LinkedHashMap$_empty(t2, t3));
      t4.set$connectTimeout(_null);
      t2 = t4;
      t1.DioMixin___DioMixin_options_A = type$.BaseOptions._as(t2);
      t1.DioMixin___DioMixin_httpClientAdapter_A = new A.BrowserHttpClientAdapter(A.LinkedHashSet_LinkedHashSet$_empty(type$.JSObject));
      return t1;
    },
    ...
    addProgress(stream, $length, options) {
      if (type$.Stream_Uint8List._is(stream))
        return stream;
      return stream.$ti._eval$1("StreamTransformer<Stream.T,Uint8List>")._as(A._transform(stream, $length, options, type$.List_int)).bind$1(stream);
    },
    ...
    ClienteAntiCaptcha: function ClienteAntiCaptcha(t0, t1) {
      this.chaveApi = t0;
      this._dio = t1;
    },
    NfeCacheManager: function NfeCacheManager(t0) {
      this._storage = t0;
    },
    NfeCacheEntry: function NfeCacheEntry(t0, t1, t2, t3, t4) {
      var _ = this;
      _.urlDownload = t0;
      _.idDocumento = t1;
      _.tamanho = t2;
    ...
    NfeCacheEntry_paraResultado_closure: function NfeCacheEntry_paraResultado_closure(t0, t1) {
      this.$this = t0;
      this.bytesNaoNulos = t1;
    },
    NfeCacheStorage: function NfeCacheStorage() {
    },
      ...
      var $async$SharedPreferences_getInstance = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $.SharedPreferences__instance;
              if (t1 == null) {
                t1 = type$.String;
                t1 = $.SharedPreferences__instance = new A.SharedPreferences(A.LinkedHashMap_LinkedHashMap$_empty(t1, t1));
              }
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
    ...
    CookieManager: function CookieManager() {
    },
    ExcecaoAntiCaptcha$(mensagem, codigoErro) {
      return new A.ExcecaoAntiCaptcha(codigoErro, mensagem, null);
    },
    ExcecaoApiNfe$(mensagem, codigoStatus, erroOriginal, rastreamentoPilha) {
      return new A.ExcecaoApiNfe(codigoStatus, mensagem, erroOriginal);
    },
    ExcecaoDocumentoNaoEncontrado$(mensagem, codigoStatus) {
      return new A.ExcecaoDocumentoNaoEncontrado(codigoStatus, mensagem, null);
    },
    ExcecaoRede$(mensagem, erroOriginal, rastreamentoPilha) {
      return new A.ExcecaoRede(mensagem, erroOriginal);
    },
    ExcecaoTempoEsgotado$(mensagem, erroOriginal, rastreamentoPilha) {
      return new A.ExcecaoTempoEsgotado(mensagem, erroOriginal);
    },
    ExcecaoNfe: function ExcecaoNfe() {
    },
    ExcecaoAntiCaptcha: function ExcecaoAntiCaptcha(t0, t1, t2) {
      this.codigoErro = t0;
      this.mensagem = t1;
      this.erroOriginal = t2;
    },
    ExcecaoTempoEsgotadoCaptcha: function ExcecaoTempoEsgotadoCaptcha(t0, t1) {
      this.mensagem = t0;
      this.erroOriginal = t1;
    },
    ExcecaoApiNfe: function ExcecaoApiNfe(t0, t1, t2) {
      this.codigoStatus = t0;
      this.mensagem = t1;
      this.erroOriginal = t2;
    },
    ExcecaoDocumentoNaoEncontrado: function ExcecaoDocumentoNaoEncontrado(t0, t1, t2) {
      this.codigoStatus = t0;
      this.mensagem = t1;
      this.erroOriginal = t2;
    },
    ExcecaoSenhaInvalida: function ExcecaoSenhaInvalida(t0, t1, t2) {
      this.codigoStatus = t0;
      this.mensagem = t1;
      this.erroOriginal = t2;
    },
    ExcecaoRede: function ExcecaoRede(t0, t1) {
      this.mensagem = t0;
      this.erroOriginal = t1;
    },
    ExcecaoTempoEsgotado: function ExcecaoTempoEsgotado(t0, t1) {
      this.mensagem = t0;
      this.erroOriginal = t1;
    },
    RequisicaoCriarTarefaAntiCaptcha: function RequisicaoCriarTarefaAntiCaptcha(t0, t1) {
      this.chaveCliente = t0;
      this.tarefa = t1;
    },
    TarefaRecaptchaV2SemProxy: function TarefaRecaptchaV2SemProxy(t0, t1) {
      this.urlSite = t0;
      this.chaveSite = t1;
    },
    RespostaCriarTarefaAntiCaptcha: function RespostaCriarTarefaAntiCaptcha(t0, t1, t2, t3) {
      var _ = this;
      _.idErro = t0;
      _.codigoErro = t1;
      _.descricaoErro = t2;
    ...
    RequisicaoObterResultadoAntiCaptcha: function RequisicaoObterResultadoAntiCaptcha(t0, t1) {
      this.chaveCliente = t0;
      this.idTarefa = t1;
    },
    RespostaObterResultadoAntiCaptcha: function RespostaObterResultadoAntiCaptcha(t0, t1, t2, t3, t4) {
      var _ = this;
      _.idErro = t0;
      _.codigoErro = t1;
      _.descricaoErro = t2;
    ...
    ClienteApiNfe: function ClienteApiNfe(t0) {
      this._nfe_api_client$_dio = t0;
    },
    ClienteApiNfe_buscarDocumento_closure: function ClienteApiNfe_buscarDocumento_closure() {
    },
    ClienteApiNfe_obterIdDocumento_closure: function ClienteApiNfe_obterIdDocumento_closure() {
    },
    ClienteApiNfe_baixarPdf_closure: function ClienteApiNfe_baixarPdf_closure() {
    },
    BaixadorNfeCidades: function BaixadorNfeCidades() {
    },
    _BaixadorNfeExecutor: function _BaixadorNfeExecutor(t0, t1) {
      this._clienteCaptcha = t0;
      this._clienteNfe = t1;
      this.___BaixadorNfeExecutor__cacheManager_F = $;
    },
    _BaixadorNfeExecutor_baixarNfe_closure: function _BaixadorNfeExecutor_baixarNfe_closure(t0) {
      this.tempoLimiteEfetivo = t0;
    },
    _BaixadorNfeExecutor__baixarNfeComCache_closure: function _BaixadorNfeExecutor__baixarNfeComCache_closure() {
    },
    _BaixadorNfeExecutor__baixarNfeComCache_closure0: function _BaixadorNfeExecutor__baixarNfeComCache_closure0() {
    },
    _BaixadorNfeExecutor__baixarNfeInterno_closure: function _BaixadorNfeExecutor__baixarNfeInterno_closure(t0, t1) {
      this.idDocumento = t0;
      this.bytesNaoNulos = t1;
    },
    _parseUri(uri) {
    ...
    consolidateBytes$body(stream) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], chunk, t1, builder;
    ...
    salvarWeb(bytes, nomeArquivo) {
      return A.salvarWeb$body(bytes, nomeArquivo);
    },
    salvarWeb$body(bytes, nomeArquivo) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$next = [], jsBytes, blobParts, blob, url, anchor, e, t1, exception;
      var $async$salvarWeb = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              try {
                jsBytes = bytes;
                blobParts = A._setArrayType([jsBytes], type$.JSArray_NativeUint8List);
                t1 = init.G;
                blob = A._asJSObject(new t1.Blob(blobParts));
                url = A._asString(t1.URL.createObjectURL(blob));
                try {
                  anchor = A._asJSObject(A._asJSObject(t1.document).createElement("a"));
                  anchor.href = url;
                  anchor.download = nomeArquivo;
                  anchor.click();
                } finally {
                  t1.URL.revokeObjectURL(url);
                }
              } catch (exception) {
                e = A.unwrapException(exception);
                t1 = A.Exception_Exception("Erro ao disparar download na web: " + A.S(e));
                throw A.wrapException(t1);
              }
              // implicit return
      ...
      return A._asyncStartSync($async$salvarWeb, $async$completer);
    },
    NfeFileSaver_salvar(bytes, caminho, nomeArquivo) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, t1;
      var $async$NfeFileSaver_salvar = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              if ($.PlatformDetector__isWebCached == null)
                $.PlatformDetector__isWebCached = true;
              t1 = A.salvarWeb(bytes, nomeArquivo);
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
              break;
      ...
      return A._asyncStartSync($async$NfeFileSaver_salvar, $async$completer);
    },
    current() {
    ...
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], resultado, e, e0, e1, e2, e3, e4, exception, t1, $async$exception;
      var $async$main = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              A.print("\ud83d\ude80 Iniciando download de NFe...\n");
              $async$handler = 3;
              $async$goto = 6;
              return A._asyncAwait(B.C_BaixadorNfeCidades.call$2$baixarBytes$senha(true, "SENHA_DA_NFE"), $async$main);
            case 6:
              // returning from await.
              resultado = $async$result;
              A.print("\u2705 Download conclu\xeddo com sucesso!\n");
              A.print("\ud83d\udcc4 Informa\xe7\xf5es da NFe:");
              A.print("   URL: " + A._asString(resultado.$index(0, "urlDownload")));
              A.print("   ID do Documento: " + A._asString(resultado.$index(0, "idDocumento")));
              A.print("   Tamanho: " + A._asInt(resultado.$index(0, "tamanho")) + " bytes\n");
              A.print("\ud83d\udcbe Salvando PDF...");
              $async$goto = 7;
              return A._asyncAwait(type$.nullable_Future_void_Function_$named_nome_nullable_String._as(resultado.$index(0, "salvar")).call$0(), $async$main);
            case 7:
              // returning from await.
              A.print("\u2705 PDF salvo: " + A._asString(resultado.$index(0, "idDocumento")) + ".pdf");
              A.print("");
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
            ...
            case 3:
              ...
              if (t1 instanceof A.ExcecaoSenhaInvalida) {
                e = t1;
                A.print("\u274c Senha inv\xe1lida: " + A.S(e));
              } else if (t1 instanceof A.ExcecaoDocumentoNaoEncontrado) {
                e0 = t1;
                A.print("\u274c Documento n\xe3o encontrado: " + A.S(e0));
              } else if (t1 instanceof A.ExcecaoTempoEsgotadoCaptcha) {
                e1 = t1;
                A.print("\u274c Timeout ao resolver captcha: " + A.S(e1));
              } else if (t1 instanceof A.ExcecaoAntiCaptcha) {
                e2 = t1;
                A.print("\u274c Erro na API Anti-Captcha: " + A.S(e2));
                A.print("   Verifique se voc\xea tem cr\xe9ditos suficientes em sua conta");
              } else if (t1 instanceof A.ExcecaoRede) {
                e3 = t1;
                A.print("\u274c Erro de rede: " + A.S(e3));
              } else if (t1 instanceof A.ExcecaoNfe) {
                e4 = t1;
                A.print("\u274c Erro: " + A.S(e4));
              } else
  ...
  A.Stream_Stream$fromIterable_closure.prototype = {
    call$1(controller) {
      var e, s, error, t2, exception, t3, zone, t1 = {};
  ...
  A.Stream_Stream$fromIterable_closure_next.prototype = {
    call$0() {
      var hasNext, e, s, error, e0, s0, error0, t2, exception, t3, t4, _this = this,
        t1 = _this.controller;
      if ((t1._state & 1) !== 0)
  ...
  A._BoundSinkStream.prototype = {
    listen$4$cancelOnError$onDone$onError(onData, cancelOnError, onDone, onError) {
      ...
      t5 = A._BufferingStreamSubscription__registerErrorHandler(t2, onError);
      subscription = new A._SinkTransformerStreamSubscription(t4, t5, type$.void_Function._as(onDone), t2, t3 | 32, t1._eval$1("_SinkTransformerStreamSubscription<1,2>"));
  ...
  A.ListBase.prototype = {
    ...
    addAll$1(receiver, iterable) {
      ...
      for (_i = 0; false; ++_i) {
        this.add$1(receiver, iterable[_i]);
        ++i;
      }
    },
    sort$1(receiver, compare) {
  ...
  A.SetBase.prototype = {
    ...
    join$1(_, separator) {
      var t1, first, t2, t3,
        iterator = A._LinkedHashSetIterator$(this, this._collection$_modifications, this.$ti._precomputed1);
      if (!iterator.moveNext$0())
        return "";
  ...
  A.DateTime.prototype = {
    ...
    get$hashCode(_) {
      return A.Object_hash(this._value, this._microsecond, B.C_SentinelValue);
    },
    toString$0(_) {
      var _this = this,
  ...
  A.Duration.prototype = {
    get$inSeconds() {
      return B.JSInt_methods._tdivFast$1(this._duration, 1000000);
    },
    $eq(_, other) {
      if (other == null)
        return false;
  ...
  A.CancelableCompleter.prototype = {
    ...
    _cancelable_operation$_cancel$0() {
      ...
      if (_this._inner != null) {
        _this._inner = null;
        cancelCompleter.complete$1(_this._invokeCancelCallbacks$0());
      }
      return cancelCompleter.future;
    },
    _invokeCancelCallbacks$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_Object),
        $async$returnValue, t1;
      var $async$_invokeCancelCallbacks$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = A._setArrayType([], type$.JSArray_Future_nullable_Object);
              $async$goto = t1.length !== 0 ? 3 : 4;
              break;
            case 3:
              // then
              $async$goto = 5;
              return A._asyncAwait(A.Future_wait(t1, type$.nullable_Object), $async$_invokeCancelCallbacks$0);
            case 5:
              // returning from await.
            case 4:
              // join
      ...
      return A._asyncStartSync($async$_invokeCancelCallbacks$0, $async$completer);
    }
  };
  ...
  A.DioException.prototype = {
    toString$0(_) {
      ...
      try {
        t1 = A.defaultDioExceptionReadableStringBuilder(this);
        return t1;
      } catch (exception) {
        e = A.unwrapException(exception);
        s = A.getTraceFromException(exception);
        J.toString$0$(e);
        return A.defaultDioExceptionReadableStringBuilder(this);
      }
    },
    $isException: 1
  };
  A.DioMixin.prototype = {
    $get$1$3$options$queryParameters(path, options, queryParameters, $T) {
      type$.nullable_Map_String_dynamic._as(queryParameters);
      return this.request$1$6$cancelToken$data$onReceiveProgress$options$queryParameters(path, null, null, null, A.DioMixin_checkOptions("GET", options), queryParameters, $T);
    },
    post$1$3$data$options(path, data, options, $T) {
      var _null = null;
      return this.request$1$7$cancelToken$data$onReceiveProgress$onSendProgress$options$queryParameters(path, _null, data, _null, _null, A.DioMixin_checkOptions("POST", options), _null, $T);
    },
    request$1$7$cancelToken$data$onReceiveProgress$onSendProgress$options$queryParameters(path, cancelToken, data, onReceiveProgress, onSendProgress, options, queryParameters, $T) {
      return this.request$body$DioMixin(path, cancelToken, data, onReceiveProgress, onSendProgress, options, type$.nullable_Map_String_dynamic._as(queryParameters), $T, $T._eval$1("Response<0>"));
    },
    request$1$6$cancelToken$data$onReceiveProgress$options$queryParameters(path, cancelToken, data, onReceiveProgress, options, queryParameters, $T) {
      return this.request$1$7$cancelToken$data$onReceiveProgress$onSendProgress$options$queryParameters(path, cancelToken, data, onReceiveProgress, null, options, queryParameters, $T);
    },
    request$body$DioMixin(path, cancelToken, data, onReceiveProgress, onSendProgress, options, queryParameters, $T, $async$type) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter($async$type),
        $async$returnValue, $async$self = this, t2, t3, t4, query, t5, headers, contentType, extra, method, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, requestOptions, t1;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t5 = options.headers;
              if (t5 != null)
                headers.addAll$1(0, t5);
              contentType = A._asStringQ(headers.$index(0, "content-type"));
              t5 = t1.___RequestConfig_extra_A;
              t5 === $ && A.throwLateFieldNI("extra");
              extra = A.LinkedHashMap_LinkedHashMap$from(t5, t3, t4);
              t3 = options.method;
              if (t3 == null) {
              ...
              t6 = t1._sendTimeout;
              t7 = t1._receiveTimeout;
              t8 = options.responseType;
              if (t8 == null) {
                t8 = t1.___RequestConfig_responseType_A;
                t8 === $ && A.throwLateFieldNI("responseType");
              }
              t9 = options.validateStatus;
              if (t9 == null) {
                t9 = t1.___RequestConfig_validateStatus_A;
                t9 === $ && A.throwLateFieldNI("validateStatus");
              }
              t10 = t1.___RequestConfig_receiveDataWhenStatusError_A;
              t10 === $ && A.throwLateFieldNI("receiveDataWhenStatusError");
              t11 = t1.___RequestConfig_followRedirects_A;
              t11 === $ && A.throwLateFieldNI("followRedirects");
              t12 = t1.___RequestConfig_maxRedirects_A;
              t12 === $ && A.throwLateFieldNI("maxRedirects");
              t13 = t1.___RequestConfig_persistentConnection_A;
              t13 === $ && A.throwLateFieldNI("persistentConnection");
              t14 = t1.requestEncoder;
              t15 = t1.responseDecoder;
              t16 = t1.___RequestConfig_listFormat_A;
              t16 === $ && A.throwLateFieldNI("listFormat");
              t17 = contentType == null ? null : contentType;
              t1 = t17 == null ? A._asStringQ(t1.___RequestConfig__headers_A.$index(0, "content-type")) : t17;
              requestOptions = new A.RequestOptions(data, path, cancelToken, onReceiveProgress, onSendProgress, $, $, null, method, t4, t6, t7, t8, t9, t10, extra, t11, t12, t13, t14, t15, t16);
              requestOptions._RequestConfig$16$contentType$extra$followRedirects$headers$listFormat$maxRedirects$method$persistentConnection$preserveHeaderCase$receiveDataWhenStatusError$receiveTimeout$requestEncoder$responseDecoder$responseType$sendTimeout$validateStatus(t1, extra, t11, headers, t16, t12, method, t13, t4, t10, t7, t14, t15, t8, t6, t9);
              requestOptions.sourceStackTrace = t2;
              requestOptions.OptionsMixin___OptionsMixin_queryParameters_A = type$.Map_String_dynamic._as(query);
              requestOptions.set$baseUrl(t3);
              requestOptions.set$connectTimeout(t5);
              if ($async$self.DioMixin__closed)
                throw A.wrapException(A.DioException_DioException$connectionError("Dio can't establish a new connection after it was closed.", requestOptions));
    ...
    fetch$1$1(requestOptions, $T) {
      return this.fetch$body$DioMixin(requestOptions, $T, $T._eval$1("Response<0>"));
    },
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              if (A.createRuntimeType($T) !== B.Type_dynamic_wn9) {
              ...
              for (t1 = new A.ListIterator(t2, t2.get$length(0), t4); t1.moveNext$0();) {
                ...
                fun = (t2 == null ? t3._as(t2) : t2).get$onError();
    ...
    _dispatchRequest$body$DioMixin(reqOpt, $T) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, stream, operation, operationWeakReference, responseBody, headers, ret, statusOk, data, e, t1, t2, value, t3, t4, message, buffer, exception, cancelToken, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 7:
              ...
              t2 = t1.fetch$3(reqOpt, stream, t2);
              t1 = $.Zone__current;
              t1 = new A.CancelableCompleter(new A._AsyncCompleter(new A._Future(t1, type$._Future_ResponseBody), type$._AsyncCompleter_ResponseBody), new A._AsyncCompleter(new A._Future(t1, type$._Future_nullable_Object), type$._AsyncCompleter_nullable_Object), null, type$.CancelableCompleter_ResponseBody);
              t1.complete$1(t2);
              value = t1.__CancelableCompleter_operation_FI;
              operation = value === $ ? t1.__CancelableCompleter_operation_FI = new A.CancelableOperation(t1, type$.CancelableOperation_ResponseBody) : value;
            ...
            case 8:
              ...
              t2 === $ && A.throwLateFieldNI("preserveHeaderCase");
              headers = A.Headers$fromMap(t1, t2);
              responseBody.set$headers(headers._headers$_map);
            ...
            case 9:
              // then
              responseBody.set$stream(A.handleResponseStream(reqOpt, responseBody));
              $async$goto = 12;
    ...
    _transformData$1(options) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, _box_0, transformed, bytes, $length, group, groupCount, i, start, stream, t1;
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (!$async$self._isValidToken$1(t1))
                throw A.wrapException(A.ArgumentError$value(options.get$method(), "method", null));
              $async$goto = options.data != null ? 3 : 4;
              break;
            case 3:
              // then
              _box_0 = {};
  ...
  A.DioMixin_fetch_closure0.prototype = {
    ...
    $call$body$DioMixin_fetch_closure(reqOpt, handler) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], $async$self = this, value, e, t1, t2, exception, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 6:
              ...
              t2.complete$1(new A.InterceptorState(t1, B.InterceptorResultType_2, type$.InterceptorState_Response_dynamic));
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
  ...
  A.RequestInterceptorHandler.prototype = {
    next$1(requestOptions) {
      var t1 = this._completer;
      if ((t1.future._state & 30) !== 0)
        A.throwExpression(A.StateError$(string$.The__h));
      t1.complete$1(new A.InterceptorState(requestOptions, B.InterceptorResultType_0, type$.InterceptorState_RequestOptions));
    }
  };
  A.ResponseInterceptorHandler.prototype = {
    next$1(response) {
      ...
      if ((t1.future._state & 30) !== 0)
        A.throwExpression(A.StateError$(string$.The__h));
      t1.complete$1(new A.InterceptorState(response, B.InterceptorResultType_0, type$.InterceptorState_Response_dynamic));
    }
  };
  A.ErrorInterceptorHandler.prototype = {
    next$1(error) {
      ...
      if ((t1.future._state & 30) !== 0)
        A.throwExpression(A.StateError$(string$.The__h));
      t1.completeError$2(new A.InterceptorState(error, B.InterceptorResultType_0, type$.InterceptorState_DioException), error.stackTrace);
    }
  };
  A.Interceptor0.prototype = {
    onRequest$2(options, handler) {
      type$.RequestOptions._as(options);
      type$.RequestInterceptorHandler._as(handler).next$1(options);
    },
    onResponse$2(response, handler) {
      type$.Response_dynamic._as(response);
      type$.ResponseInterceptorHandler._as(handler).next$1(response);
    },
    onError$2(err, handler) {
      type$.DioException._as(err);
      type$.ErrorInterceptorHandler._as(handler).next$1(err);
    }
  };
  ...
  A.ImplyContentTypeInterceptor.prototype = {
    onRequest$2(options, handler) {
      ...
      if (options.data != null) {
        ...
        t1 = false;
      if (t1)
        options.set$contentType("application/json");
      handler.next$1(options);
    }
  };
  ...
  A._RequestConfig.prototype = {
    _RequestConfig$16$contentType$extra$followRedirects$headers$listFormat$maxRedirects$method$persistentConnection$preserveHeaderCase$receiveDataWhenStatusError$receiveTimeout$requestEncoder$responseDecoder$responseType$sendTimeout$validateStatus(contentType, extra, followRedirects, headers, listFormat, maxRedirects, method, persistentConnection, preserveHeaderCase, receiveDataWhenStatusError, receiveTimeout, requestEncoder, responseDecoder, responseType, sendTimeout, validateStatus) {
      var hasContentTypeHeader, _this = this,
        _s12_ = "content-type",
        t1 = type$.Map_String_dynamic._as(A.caseInsensitiveKeyMap(type$.nullable_Map_String_dynamic._as(headers), type$.dynamic));
      _this.___RequestConfig__headers_A = t1;
      if (!t1.containsKey$1(_s12_) && _this._defaultContentType != null)
      ...
      if (!hasContentTypeHeader)
        _this.set$contentType(contentType);
    },
    get$method() {
  ...
  A.FusedTransformer.prototype = {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              t1 = B.C_Utf8Codec.decode$2$allowMalformed(responseBytes, true);
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
              break;
    ...
    _fastUtf8JsonDecode$2(options, responseBody) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_Object),
        $async$returnValue, $async$self = this, responseBytes, contentLength, t1, streamWithNullFallback, decoded, contentLengthHeader;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = !(contentLengthHeader != null && J.get$isNotEmpty$asx(contentLengthHeader)) ? 3 : 5;
              break;
            case 3:
              // then
              $async$goto = 6;
            ...
            case 5:
              // else
              contentLength = A.int_parse(J.get$first$ax(contentLengthHeader));
              responseBytes = null;
            case 4:
              // join
            ...
            case 11:
              // join
              t1 = $async$result;
              $async$returnValue = A.compute_impl__compute$closure().call$2$2(A.fused_transformer_FusedTransformer__decodeUtf8ToJson$closure(), t1, type$.Uint8List, type$.nullable_Object);
              // goto return
              $async$goto = 1;
              break;
              // goto join
            ...
            case 9:
              // else
              $async$goto = responseBytes != null ? 14 : 16;
              break;
            case 14:
              // then
            ...
            case 16:
              // else
              t1 = responseBody.stream;
              streamWithNullFallback = A._instanceType(t1)._eval$1("StreamTransformer<Stream.T,Uint8List>")._as(B.C_DefaultNullIfEmptyStreamTransformer).bind$1(t1);
              $async$goto = 17;
              return A._asyncAwait($.$get$FusedTransformer__utf8JsonDecoder().bind$1(streamWithNullFallback).toList$0(0), $async$_fastUtf8JsonDecode$2);
            case 17:
              // returning from await.
  ...
  A.DefaultNullIfEmptyStreamTransformer.prototype = {
    bind$1(stream) {
      return new A._BoundSinkStream(new A.DefaultNullIfEmptyStreamTransformer_bind_closure(), type$.Stream_Uint8List._as(stream), type$._BoundSinkStream_dynamic_Uint8List);
    }
  };
  A.DefaultNullIfEmptyStreamTransformer_bind_closure.prototype = {
    call$1(sink) {
      return new A._DefaultIfEmptyStreamSink(type$.EventSink_Uint8List._as(sink));
    },
    $signature: 38
  };
  A._DefaultIfEmptyStreamSink.prototype = {
    add$1(_, data) {
      var t1, t2;
      type$.Uint8List._as(data);
      this._hasData = this._hasData || data.length !== 0;
      t1 = this._outputSink;
      t2 = t1._async$_sink;
      data = t2.$ti._rest[1]._as(t1.$ti._precomputed1._as(data));
      if ((t2._state & 2) !== 0)
        A.throwExpression(A.StateError$("Stream is already closed"));
      t2.super$_BufferingStreamSubscription$_add(data);
    },
    addError$2(e, st) {
      return this._outputSink.addError$2(e, st);
    },
    close$0() {
      var t1, t2,
        _s24_ = "Stream is already closed";
      if (!this._hasData) {
        t1 = this._outputSink;
        t2 = t1._async$_sink;
        t1 = t2.$ti._rest[1]._as(t1.$ti._precomputed1._as($.$get$_DefaultIfEmptyStreamSink__nullUtf8Value()));
        if ((t2._state & 2) !== 0)
          A.throwExpression(A.StateError$(_s24_));
        t2.super$_BufferingStreamSubscription$_add(t1);
      }
      t1 = this._outputSink._async$_sink;
      if ((t1._state & 2) !== 0)
        A.throwExpression(A.StateError$(_s24_));
      t1.super$_BufferingStreamSubscription$_close();
    },
  ...
  A.encodeMap_urlEncode.prototype = {
    call$2(sub, path) {
      ...
      if (t1._is(sub)) {
        ...
        sub.forEach$1(0, new A.encodeMap_urlEncode_closure(path, _this, _this.maybeEncode, _this.encodeComponent, _this.leftBracket, _this.rightBracket));
      else {
  ...
  A.BrowserHttpClientAdapter.prototype = {
    fetch$3(options, requestStream, cancelFuture) {
      return this.fetch$body$BrowserHttpClientAdapter(options, type$.nullable_Stream_Uint8List._as(requestStream), cancelFuture);
    },
    fetch$body$BrowserHttpClientAdapter(options, requestStream, cancelFuture) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, t2, t3, withCredentialsOption, completer, t4, t5, t6, receiveStopwatch, t7, t8, sink, t1, xhr, $async$temp1;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t2 === $ && A.throwLateFieldNI("method");
              xhr.open(t2, options.get$uri().toString$0(0));
              xhr.responseType = "arraybuffer";
              t3 = options.___RequestConfig_extra_A;
              t3 === $ && A.throwLateFieldNI("extra");
              withCredentialsOption = t3.$index(0, "withCredentials");
              if (withCredentialsOption != null)
                xhr.withCredentials = J.$eq$(withCredentialsOption, true);
              else
                xhr.withCredentials = false;
              t3 = options.___RequestConfig__headers_A;
              t3 === $ && A.throwLateFieldNI("_headers");
              t3.remove$1(0, "content-length");
              ...
              t4 = type$._EventStream_JSObject;
              t5 = type$.Null;
              new A._EventStream(xhr, "load", false, t4).get$first(0).then$1$1(new A.BrowserHttpClientAdapter_fetch_closure0(xhr, completer, options), t5);
              t1.connectTimeoutTimer = null;
              t6 = requestStream != null;
              if (t6)
                A._asJSObject(xhr.upload);
              receiveStopwatch = new A.Stopwatch();
              $.$get$Stopwatch__frequency();
              t1.receiveTimer = null;
              t7 = new A.BrowserHttpClientAdapter_fetch_stopWatchReceiveTimeout(t1, receiveStopwatch);
              t8 = type$.nullable_void_Function_JSObject._as(new A.BrowserHttpClientAdapter_fetch_closure1(t1, new A.BrowserHttpClientAdapter_fetch_watchReceiveTimeout(t1, B.Duration_0, receiveStopwatch, completer, xhr, options, t7), options));
              type$.nullable_void_Function._as(new A.BrowserHttpClientAdapter_fetch_closure2(t7));
              A._EventStreamSubscription$(xhr, "progress", t8, false, type$.JSObject);
              new A._EventStream(xhr, "error", false, t4).get$first(0).then$1$1(new A.BrowserHttpClientAdapter_fetch_closure3(t1, completer, options), t5);
              new A._EventStream(xhr, "timeout", false, t4).get$first(0).then$1$1(new A.BrowserHttpClientAdapter_fetch_closure4(t1, completer, B.Duration_0, options, 0), t5);
              $async$goto = t6 ? 3 : 5;
              break;
            case 3:
              // then
              ...
              requestStream.listen$4$cancelOnError$onDone$onError(type$.void_Function_List_int._as(sink.get$add(sink)), true, sink.get$close(), new A.BrowserHttpClientAdapter_fetch_closure6(completer));
              $async$temp1 = xhr;
              $async$goto = 6;
            ...
            case 4:
              // join
              $async$returnValue = t3.whenComplete$1(new A.BrowserHttpClientAdapter_fetch_closure7($async$self, xhr));
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    close$1$force(force) {
      var t1, t2, t3;
      for (t1 = this.xhrs, t1 = A._LinkedHashSetIterator$(t1, t1._collection$_modifications, t1.$ti._precomputed1), t2 = t1.$ti._precomputed1; t1.moveNext$0();) {
  ...
  A.BrowserHttpClientAdapter_fetch_closure0.prototype = {
    call$1(_) {
      ...
      A._asJSObject(_);
      t1 = this.xhr;
      t2 = A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(t1.response), 0, _null);
      t3 = A._asInt(t1.status);
      t4 = A._extension_0_getResponseHeaders(t1);
      t5 = A._asString(t1.statusText);
      t1 = A._asInt(t1.status) === 302 || A._asInt(t1.status) === 301 || this.options.get$uri().toString$0(0) !== A._asString(t1.responseURL);
      t6 = type$._AsyncStreamController_Uint8List;
      t7 = new A._AsyncStreamController(_null, _null, _null, _null, t6);
      t7._async$_add$1(t2);
      t7._closeUnchecked$0();
      this.completer.complete$1(new A.ResponseBody(t1, new A._ControllerStream(t7, t6._eval$1("_ControllerStream<1>")), t3, t5, t4, A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic)));
    },
    $signature: 10
  };
  ...
  A.BrowserHttpClientAdapter_fetch_closure5.prototype = {
    call$1(bytes) {
      type$.List_int._as(bytes);
      return this.completer.complete$1(bytes);
    },
    $signature: 46
  };
  A.BrowserHttpClientAdapter_fetch_closure6.prototype = {
    call$2(e, s) {
      return this.completer.completeError$2(A._asObject(e), type$.StackTrace._as(s));
    },
    $signature: 2
  };
  ...
  A.MediaType_MediaType$parse_closure.prototype = {
    call$0() {
      ...
      for (;;) {
        ...
        t7.toString;
        scanner.expect$1("=");
        t8 = scanner._lastMatch = t3.matchAsPrefix$2(0, t1, scanner._position);
  ...
  A.ClienteAntiCaptcha.prototype = {
    resolverRecaptchaV2$2$chaveSite$urlSite(chaveSite, urlSite) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$self = this, t2, resultado, t3, t4, idTarefa, t1;
      var $async$resolverRecaptchaV2$2$chaveSite$urlSite = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait($async$self._criarTarefa$2(urlSite, chaveSite), $async$resolverRecaptchaV2$2$chaveSite$urlSite);
            case 3:
              // returning from await.
              idTarefa = $async$result;
              t1 = Date.now();
              t2 = type$.dynamic;
            case 4:
              // for condition
              if (!(A.Duration$(0, Date.now() - t1)._duration < 180000000)) {
                // goto after for
                $async$goto = 5;
                break;
              }
              $async$goto = 6;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_2000000, t2), $async$resolverRecaptchaV2$2$chaveSite$urlSite);
            case 6:
              // returning from await.
              $async$goto = 7;
              return A._asyncAwait($async$self._obterResultadoTarefa$1(idTarefa), $async$resolverRecaptchaV2$2$chaveSite$urlSite);
            case 7:
              // returning from await.
              resultado = $async$result;
              t3 = resultado.idErro;
              if (t3 != null && t3 > 0) {
                t1 = resultado.descricaoErro;
                if (t1 == null)
                  t1 = "Erro desconhecido do Anti-Captcha";
                throw A.wrapException(A.ExcecaoAntiCaptcha$(t1, resultado.codigoErro));
              }
              t3 = resultado.status;
              if (t3 === "ready") {
                t4 = resultado.solucao;
                t4 = A._asStringQ(t4 == null ? null : t4.$index(0, "gRecaptchaResponse")) != null;
              } else
                t4 = false;
              if (t4) {
                t1 = resultado.solucao;
                t1 = A._asStringQ(t1 == null ? null : t1.$index(0, "gRecaptchaResponse"));
                t1.toString;
                $async$returnValue = t1;
                // goto return
                $async$goto = 1;
              ...
              if (t3 !== "processing")
                throw A.wrapException(A.ExcecaoAntiCaptcha$("Status inesperado: " + A.S(t3), null));
              // goto for condition
              $async$goto = 4;
              break;
            case 5:
              // after for
              throw A.wrapException(new A.ExcecaoTempoEsgotadoCaptcha("Resolu\xe7\xe3o do captcha expirou ap\xf3s " + B.Duration_180000000.get$inSeconds() + " segundos", null));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
      });
      return A._asyncStartSync($async$resolverRecaptchaV2$2$chaveSite$urlSite, $async$completer);
    },
    _criarTarefa$2(urlSite, chaveSite) {
      return this._criarTarefa$body$ClienteAntiCaptcha(urlSite, chaveSite);
    },
    _criarTarefa$body$ClienteAntiCaptcha(urlSite, chaveSite) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, requisicao, resposta, resultado, erro, rastreamentoPilha, t1, t2, t3, t4, exception, $async$exception;
      var $async$_criarTarefa$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$handler = 4;
              requisicao = new A.RequisicaoCriarTarefaAntiCaptcha($async$self.chaveApi, new A.TarefaRecaptchaV2SemProxy(urlSite, chaveSite));
              t1 = requisicao;
              t2 = t1.chaveCliente;
              t1 = t1.tarefa;
              t3 = type$.String;
              t4 = type$.dynamic;
              $async$goto = 7;
              return A._asyncAwait($async$self._dio.post$1$3$data$options("https://api.anti-captcha.com/createTask", B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["clientKey", t2, "task", A.LinkedHashMap_LinkedHashMap$_literal(["type", "RecaptchaV2TaskProxyless", "websiteURL", t1.urlSite, "websiteKey", t1.chaveSite], t3, t4)], t3, t4), null), A.Options$(A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "application/json"], t3, t4), null, null), t4), $async$_criarTarefa$2);
            case 7:
              // returning from await.
              resposta = $async$result;
              t4 = type$.Map_String_dynamic._as(resposta.data);
              resultado = new A.RespostaCriarTarefaAntiCaptcha(A._asIntQ(t4.$index(0, "errorId")), A._asStringQ(t4.$index(0, "errorCode")), A._asStringQ(t4.$index(0, "errorDescription")), A._asIntQ(t4.$index(0, "taskId")));
              t1 = resultado.idErro;
              if (t1 != null && t1 > 0) {
                t1 = resultado.descricaoErro;
                if (t1 == null)
                  t1 = "Falha ao criar tarefa de captcha";
                t1 = A.ExcecaoAntiCaptcha$(t1, resultado.codigoErro);
                throw A.wrapException(t1);
              }
              if (resultado.idTarefa == null)
                throw A.wrapException(B.ExcecaoAntiCaptcha_0mq);
              t1 = resultado.idTarefa;
              t1.toString;
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
            ...
            case 4:
              ...
              if (t1 instanceof A.DioException) {
                erro = t1;
                rastreamentoPilha = A.getTraceFromException($async$exception);
                throw A.wrapException(A.ExcecaoRede$("Erro de rede ao criar tarefa de captcha", erro, rastreamentoPilha));
              } else
                throw $async$exception;
              // goto after finally
              $async$goto = 6;
      ...
      return A._asyncStartSync($async$_criarTarefa$2, $async$completer);
    },
    _obterResultadoTarefa$1(idTarefa) {
      return this._obterResultadoTarefa$body$ClienteAntiCaptcha(idTarefa);
    },
    _obterResultadoTarefa$body$ClienteAntiCaptcha(idTarefa) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.RespostaObterResultadoAntiCaptcha),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, requisicao, resposta, erro, rastreamentoPilha, t1, t2, t3, t4, t5, exception, $async$exception;
      var $async$_obterResultadoTarefa$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$handler = 4;
              requisicao = new A.RequisicaoObterResultadoAntiCaptcha($async$self.chaveApi, idTarefa);
              t1 = requisicao;
              t2 = type$.String;
              t3 = type$.dynamic;
              $async$goto = 7;
              return A._asyncAwait($async$self._dio.post$1$3$data$options("https://api.anti-captcha.com/getTaskResult", B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["clientKey", t1.chaveCliente, "taskId", t1.idTarefa], t2, t3), null), A.Options$(A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "application/json"], t2, t3), null, null), t3), $async$_obterResultadoTarefa$1);
            case 7:
              // returning from await.
              resposta = $async$result;
              t3 = type$.Map_String_dynamic._as(resposta.data);
              t2 = A._asIntQ(t3.$index(0, "errorId"));
              t1 = A._asStringQ(t3.$index(0, "errorCode"));
              t4 = A._asStringQ(t3.$index(0, "errorDescription"));
              t5 = A._asStringQ(t3.$index(0, "status"));
              t3 = type$.nullable_Map_String_dynamic._as(t3.$index(0, "solution"));
              $async$returnValue = new A.RespostaObterResultadoAntiCaptcha(t2, t1, t4, t5, t3);
              // goto return
              $async$goto = 1;
              break;
              $async$handler = 2;
            ...
            case 4:
              ...
              if (t1 instanceof A.DioException) {
                erro = t1;
                rastreamentoPilha = A.getTraceFromException($async$exception);
                throw A.wrapException(A.ExcecaoRede$("Erro de rede ao obter resultado do captcha", erro, rastreamentoPilha));
              } else
                throw $async$exception;
              // goto after finally
              $async$goto = 6;
      ...
      return A._asyncStartSync($async$_obterResultadoTarefa$1, $async$completer);
    }
  };
  A.NfeCacheManager.prototype = {
    obter$1(senha) {
      return this.obter$body$NfeCacheManager(senha);
    },
    obter$body$NfeCacheManager(senha) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_NfeCacheEntry),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, chave, jsonString, json, erro, stackTrace, t1, t2, t3, t4, t5, exception, $async$exception;
      var $async$obter$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$handler = 4;
              chave = "nfe_cache:" + senha;
              $async$goto = 7;
              return A._asyncAwait($async$self._storage.ler$1(chave), $async$obter$1);
            case 7:
              // returning from await.
              ...
              json = type$.Map_String_dynamic._as(B.C_JsonCodec.decode$2$reviver(jsonString, null));
              t1 = json;
              t2 = A._asString(t1.$index(0, "urlDownload"));
              t3 = A._asString(t1.$index(0, "idDocumento"));
              t4 = A._asInt(t1.$index(0, "tamanho"));
              t5 = A._asStringQ(t1.$index(0, "bytesBase64"));
              t1 = A.DateTime_parse(A._asString(t1.$index(0, "dataCache")));
              $async$returnValue = new A.NfeCacheEntry(t2, t3, t4, t5, t1);
              // goto return
              $async$goto = 1;
              break;
              $async$handler = 2;
            ...
            case 4:
              ...
              $async$handler = 3;
              $async$exception = $async$errorStack.pop();
              erro = A.unwrapException($async$exception);
      ...
      return A._asyncStartSync($async$obter$1, $async$completer);
    },
    salvar$2(senha, resultado) {
      return this.salvar$body$NfeCacheManager(senha, type$.Map_String_dynamic._as(resultado));
    },
    salvar$body$NfeCacheManager(senha, resultado) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], $async$self = this, entry, json, chave, erro, stackTrace, t1, exception, $async$exception;
      var $async$salvar$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$handler = 3;
              entry = new A.NfeCacheEntry(A._asString(resultado.$index(0, "urlDownload")), A._asString(resultado.$index(0, "idDocumento")), A._asInt(resultado.$index(0, "tamanho")), A._asStringQ(resultado.$index(0, "bytesBase64")), new A.DateTime(Date.now(), 0, false));
              t1 = entry;
              json = B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["urlDownload", t1.urlDownload, "idDocumento", t1.idDocumento, "tamanho", t1.tamanho, "bytesBase64", t1.bytesBase64, "dataCache", t1.dataCache.toIso8601String$0()], type$.String, type$.dynamic), null);
              chave = "nfe_cache:" + senha;
              $async$goto = 6;
              return A._asyncAwait($async$self._storage.escrever$2(chave, json), $async$salvar$2);
            case 6:
              // returning from await.
              $async$handler = 1;
              // goto after finally
      ...
      return A._asyncStartSync($async$salvar$2, $async$completer);
    }
  };
  A.NfeCacheEntry.prototype = {
    paraResultado$1$baixarBytes(baixarBytes) {
      var t1, bytes, funcaoSalvar, _this = this;
      if (baixarBytes && _this.bytesBase64 != null) {
        t1 = _this.bytesBase64;
        t1.toString;
        bytes = B.C_Base64Decoder.convert$1(t1);
        funcaoSalvar = new A.NfeCacheEntry_paraResultado_closure(_this, bytes);
      } else {
        bytes = null;
        funcaoSalvar = null;
      }
      return A.LinkedHashMap_LinkedHashMap$_literal(["urlDownload", _this.urlDownload, "idDocumento", _this.idDocumento, "tamanho", _this.tamanho, "bytes", bytes, "bytesBase64", _this.bytesBase64, "salvar", funcaoSalvar], type$.String, type$.dynamic);
    }
  };
  A.NfeCacheEntry_paraResultado_closure.prototype = {
    call$1$nome(nome) {
      return this.$call$body$NfeCacheEntry_paraResultado_closure(A._asStringQ(nome));
    },
    call$0() {
      return this.call$1$nome(null);
    },
    $call$body$NfeCacheEntry_paraResultado_closure(nome) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, nomeArquivo;
      var $async$call$1$nome = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              if (nome == null || nome.length === 0)
                nomeArquivo = $async$self.$this.idDocumento + ".pdf";
              else
                nomeArquivo = !B.JSString_methods.endsWith$1(nome.toLowerCase(), ".pdf") ? nome + ".pdf" : nome;
              $async$goto = 2;
              return A._asyncAwait(A.NfeFileSaver_salvar($async$self.bytesNaoNulos, null, nomeArquivo), $async$call$1$nome);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$call$1$nome, $async$completer);
    },
    $signature: 23
  };
  A.NfeCacheStorage.prototype = {
    ler$1(chave) {
      return this.ler$body$NfeCacheStorage(chave);
    },
    ler$body$NfeCacheStorage(chave) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_String),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], prefs, e, t1, exception, $async$exception;
      var $async$ler$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 4;
              $async$goto = 7;
              return A._asyncAwait(A.SharedPreferences_getInstance(), $async$ler$1);
            case 7:
              // returning from await.
              prefs = $async$result;
              t1 = prefs._data.$index(0, chave);
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
              break;
      ...
      return A._asyncStartSync($async$ler$1, $async$completer);
    },
    escrever$2(chave, valor) {
      return this.escrever$body$NfeCacheStorage(chave, valor);
    },
    escrever$body$NfeCacheStorage(chave, valor) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], prefs, e, t1, exception, $async$exception;
      var $async$escrever$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 4;
              $async$goto = 7;
              return A._asyncAwait(A.SharedPreferences_getInstance(), $async$escrever$2);
            case 7:
              // returning from await.
              prefs = $async$result;
              $async$goto = 8;
              return A._asyncAwait(prefs.setString$2(chave, valor), $async$escrever$2);
            case 8:
              // returning from await.
              t1 = $async$result;
              $async$returnValue = t1;
      ...
      return A._asyncStartSync($async$escrever$2, $async$completer);
    }
  };
  A.SharedPreferences.prototype = {
    setString$2(key, value) {
      ...
      var $async$setString$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$self._data.$indexSet(0, key, value);
      ...
      return A._asyncStartSync($async$setString$2, $async$completer);
    }
  };
  A.CookieManager.prototype = {
    onRequest$2(options, handler) {
      type$.RequestOptions._as(options);
      type$.RequestInterceptorHandler._as(handler).next$1(options);
    },
  ...
  A.ExcecaoNfe.prototype = {
    toString$0(_) {
      var t1 = this.erroOriginal;
      t1 = t1 != null ? " (" + A.S(t1) + ")" : "";
      return "ExcecaoNfe: " + this.mensagem + t1;
    },
    $isException: 1
  };
  A.ExcecaoAntiCaptcha.prototype = {
    toString$0(_) {
      var t1 = this.codigoErro;
      t1 = t1 != null ? " (c\xf3digo: " + t1 + ")" : "";
      return "ExcecaoAntiCaptcha: " + this.mensagem + t1;
    }
  };
  A.ExcecaoTempoEsgotadoCaptcha.prototype = {
    toString$0(_) {
      return "ExcecaoTempoEsgotadoCaptcha: " + this.mensagem;
    }
  };
  A.ExcecaoApiNfe.prototype = {
    toString$0(_) {
      var t1 = this.codigoStatus;
      t1 = t1 != null ? " (HTTP " + A.S(t1) + ")" : "";
      return "ExcecaoApiNfe: " + this.mensagem + t1;
    }
  };
  A.ExcecaoDocumentoNaoEncontrado.prototype = {
    toString$0(_) {
      return "ExcecaoDocumentoNaoEncontrado: " + this.mensagem;
    }
  };
  A.ExcecaoSenhaInvalida.prototype = {
    toString$0(_) {
      return "ExcecaoSenhaInvalida: " + this.mensagem;
    }
  };
  A.ExcecaoRede.prototype = {
    toString$0(_) {
      return "ExcecaoRede: " + this.mensagem;
    }
  };
  A.ExcecaoTempoEsgotado.prototype = {
    toString$0(_) {
      return "ExcecaoTempoEsgotado: " + this.mensagem;
    }
  };
  A.RequisicaoCriarTarefaAntiCaptcha.prototype = {};
  A.TarefaRecaptchaV2SemProxy.prototype = {};
  A.RespostaCriarTarefaAntiCaptcha.prototype = {};
  A.RequisicaoObterResultadoAntiCaptcha.prototype = {};
  A.RespostaObterResultadoAntiCaptcha.prototype = {};
  A.ClienteApiNfe.prototype = {
    buscarDocumento$2$senha$tokenCaptcha(senha, tokenCaptcha) {
      return this.buscarDocumento$body$ClienteApiNfe(senha, tokenCaptcha);
    },
    buscarDocumento$body$ClienteApiNfe(senha, tokenCaptcha) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, resposta, dados, stringResposta, decodificado, validador, dadosCriptografados, stringResposta0, preview, erro, rastreamentoPilha, t1, t2, exception, $async$exception;
      var $async$buscarDocumento$2$senha$tokenCaptcha = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.dynamic;
              $async$goto = 7;
              return A._asyncAwait($async$self._nfe_api_client$_dio.post$1$3$data$options("https://www.nfe-cidades.com.br/v2/rest/public/login/buscarDocumento", B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["captcha", tokenCaptcha, "senha", senha], t1, t1), null), A.Options$(A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "application/json", "Accept", "application/json, text/plain, */*", "Origin", "https://www.nfe-cidades.com.br", "Referer", string$.https_], t1, t2), B.ResponseType_0, new A.ClienteApiNfe_buscarDocumento_closure()), t2), $async$buscarDocumento$2$senha$tokenCaptcha);
            case 7:
              // returning from await.
              resposta = $async$result;
              if (resposta.statusCode === 401 || resposta.statusCode === 403) {
                t1 = resposta.statusCode;
                throw A.wrapException(new A.ExcecaoSenhaInvalida(t1, "Senha ou token do captcha inv\xe1lido", null));
              }
              if (resposta.statusCode !== 200) {
                t1 = A.ExcecaoApiNfe$("Falha ao buscar documento: " + A.S(resposta.statusMessage), resposta.statusCode, null, null);
                throw A.wrapException(t1);
              }
              if (resposta.data == null)
                throw A.wrapException(B.ExcecaoApiNfe_LJl);
              dados = null;
              if (typeof resposta.data == "string") {
                stringResposta = A._asString(resposta.data);
                if (J.get$length$asx(stringResposta) === 0)
                  throw A.wrapException(B.ExcecaoApiNfe_TN1);
                try {
                  decodificado = B.C_JsonCodec.decode$2$reviver(stringResposta, null);
                  if (type$.Map_String_dynamic._is(decodificado))
                    dados = decodificado;
                  else if (typeof decodificado == "string") {
                    $async$returnValue = decodificado;
                    // goto return
                    $async$goto = 1;
                    break;
                  }
                } catch (exception) {
                  $async$returnValue = stringResposta;
                  // goto return
                  $async$goto = 1;
                  break;
                }
                ...
                if (t1._is(resposta.data))
                  dados = t1._as(resposta.data);
              }
              if (dados != null) {
                if (dados.containsKey$1("validador")) {
                  validador = dados.$index(0, "validador");
                  if (typeof validador == "string") {
                    $async$returnValue = validador;
                    // goto return
                    $async$goto = 1;
                    break;
                  }
                }
                if (dados.containsKey$1("data")) {
                  dadosCriptografados = dados.$index(0, "data");
                  if (typeof dadosCriptografados == "string") {
                    $async$returnValue = dadosCriptografados;
                    // goto return
                    $async$goto = 1;
                    break;
                  }
              ...
              stringResposta0 = J.toString$0$(resposta.data);
              preview = J.get$length$asx(stringResposta0) > 200 ? J.substring$2$s(stringResposta0, 0, 200) + "..." : stringResposta0;
              t1 = A.ExcecaoApiNfe$('Resposta inv\xe1lida de buscarDocumento. Esperado JSON com campo "validador" ou "data", ou string direta. Tipo recebido: ' + J.get$runtimeType$(resposta.data).toString$0(0) + ", preview: " + A.S(preview), null, null, null);
              throw A.wrapException(t1);
              $async$handler = 2;
              // goto after finally
              $async$goto = 6;
            ...
            case 4:
              ...
              if (t1 instanceof A.DioException) {
                erro = t1;
                rastreamentoPilha = A.getTraceFromException($async$exception);
                if (erro.type === B.DioExceptionType_0 || erro.type === B.DioExceptionType_2)
                  throw A.wrapException(A.ExcecaoTempoEsgotado$("Requisi\xe7\xe3o expirou", erro, rastreamentoPilha));
                throw A.wrapException(A.ExcecaoRede$("Erro de rede em buscarDocumento", erro, rastreamentoPilha));
              } else
                throw $async$exception;
              // goto after finally
              $async$goto = 6;
      ...
      return A._asyncStartSync($async$buscarDocumento$2$senha$tokenCaptcha, $async$completer);
    },
    obterIdDocumento$2$dadosCriptografados$senha(dadosCriptografados, senha) {
      return this.obterIdDocumento$body$ClienteApiNfe(dadosCriptografados, senha);
    },
    obterIdDocumento$body$ClienteApiNfe(dadosCriptografados, senha) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, resposta, html, idDocumento, erro, rastreamentoPilha, t1, t2, t3, correspondencia, idDocumento0, exception, $async$exception;
      var $async$obterIdDocumento$2$dadosCriptografados$senha = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.String;
              t2 = type$.dynamic;
              t3 = A.LinkedHashMap_LinkedHashMap$_literal(["senha", senha, "data", dadosCriptografados], t1, t2);
              $async$goto = 7;
              return A._asyncAwait($async$self._nfe_api_client$_dio.$get$1$3$options$queryParameters("https://www.nfe-cidades.com.br/documentos.action", A.Options$(A.LinkedHashMap_LinkedHashMap$_literal(["Accept", string$.text_h, "Referer", "https://www.nfe-cidades.com.br/public/documentos?senha=" + senha + "&data=" + dadosCriptografados], t1, t2), null, new A.ClienteApiNfe_obterIdDocumento_closure()), t3, t2), $async$obterIdDocumento$2$dadosCriptografados$senha);
            case 7:
              // returning from await.
              resposta = $async$result;
              if (resposta.statusCode === 404) {
                t1 = A.ExcecaoDocumentoNaoEncontrado$("Documento n\xe3o encontrado", resposta.statusCode);
                throw A.wrapException(t1);
              }
              if (resposta.statusCode !== 200) {
                t1 = A.ExcecaoApiNfe$("Falha ao obter detalhes do documento: " + A.S(resposta.statusMessage), resposta.statusCode, null, null);
                throw A.wrapException(t1);
              }
              html = A._asString(resposta.data);
              t1 = A._asString(html);
              correspondencia = A.RegExp_RegExp('relatorioNotaFiscal\\.action\\?id=([^"&\\s]+)').firstMatch$1(t1);
              if (correspondencia == null)
                idDocumento0 = null;
              else {
                t1 = correspondencia._match;
                if (1 >= t1.length) {
              ...
              idDocumento = idDocumento0;
              if (idDocumento == null)
                throw A.wrapException(B.ExcecaoApiNfe_QW4);
              $async$returnValue = idDocumento;
              // goto return
              $async$goto = 1;
              break;
              $async$handler = 2;
            ...
            case 4:
              ...
              if (t1 instanceof A.DioException) {
                ...
                if (erro.type === B.DioExceptionType_0 || erro.type === B.DioExceptionType_2)
                  throw A.wrapException(A.ExcecaoTempoEsgotado$("Requisi\xe7\xe3o expirou", erro, rastreamentoPilha));
                throw A.wrapException(A.ExcecaoRede$("Erro de rede em obterIdDocumento", erro, rastreamentoPilha));
              } else
                throw $async$exception;
              // goto after finally
              $async$goto = 6;
      ...
      return A._asyncStartSync($async$obterIdDocumento$2$dadosCriptografados$senha, $async$completer);
    },
    baixarPdf$1(idDocumento) {
      return this.baixarPdf$body$ClienteApiNfe(idDocumento);
    },
    baixarPdf$body$ClienteApiNfe(idDocumento) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Uint8List),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, resposta, erro, rastreamentoPilha, t1, t2, t3, exception, $async$exception;
      var $async$baixarPdf$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.String;
              t2 = type$.dynamic;
              t3 = A.LinkedHashMap_LinkedHashMap$_literal(["id", idDocumento], t1, t2);
              $async$goto = 7;
              return A._asyncAwait($async$self._nfe_api_client$_dio.$get$1$3$options$queryParameters("https://www.nfe-cidades.com.br/relatorioNotaFiscal.action", A.Options$(A.LinkedHashMap_LinkedHashMap$_literal(["Accept", string$.text_h], t1, t2), B.ResponseType_3, new A.ClienteApiNfe_baixarPdf_closure()), t3, t2), $async$baixarPdf$1);
            case 7:
              // returning from await.
              resposta = $async$result;
              if (resposta.statusCode === 404) {
                t1 = A.ExcecaoDocumentoNaoEncontrado$("PDF n\xe3o encontrado para o ID do documento: " + idDocumento, resposta.statusCode);
                throw A.wrapException(t1);
              }
              if (resposta.statusCode !== 200) {
                t1 = A.ExcecaoApiNfe$("Falha ao baixar PDF: " + A.S(resposta.statusMessage), resposta.statusCode, null, null);
                throw A.wrapException(t1);
              }
              t1 = new Uint8Array(A._ensureNativeList(type$.List_int._as(resposta.data)));
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
              break;
            ...
            case 4:
              ...
              if (t1 instanceof A.DioException) {
                ...
                rastreamentoPilha = A.getTraceFromException($async$exception);
                if (erro.type === B.DioExceptionType_0 || erro.type === B.DioExceptionType_2)
                  throw A.wrapException(A.ExcecaoTempoEsgotado$("Download do PDF expirou", erro, rastreamentoPilha));
                throw A.wrapException(A.ExcecaoRede$("Erro de rede ao baixar PDF", erro, rastreamentoPilha));
              } else
                throw $async$exception;
              // goto after finally
              $async$goto = 6;
      ...
      return A._asyncStartSync($async$baixarPdf$1, $async$completer);
    }
  };
  A.ClienteApiNfe_buscarDocumento_closure.prototype = {
    call$1($status) {
      return $status < 500;
    },
    $signature: 5
  };
  A.ClienteApiNfe_obterIdDocumento_closure.prototype = {
    call$1($status) {
      return $status < 500;
    },
    $signature: 5
  };
  A.ClienteApiNfe_baixarPdf_closure.prototype = {
    call$1($status) {
      return $status < 500;
    },
    $signature: 5
  };
  A.BaixadorNfeCidades.prototype = {
    call$2$baixarBytes$senha(baixarBytes, senha) {
      var tempoLimite = null;
      A._asString(senha);
      return this.$call$body$BaixadorNfeCidades(A._asBool(baixarBytes), senha);
    },
    $call$body$BaixadorNfeCidades(baixarBytes, senha) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], executor, executor0, tempoLimite, t1, t2, t3;
      var $async$call$2$baixarBytes$senha = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              tempoLimite = null;
              t1 = A.DioForBrowser$(null);
              t2 = A.DioForBrowser$(null);
              t3 = $.PlatformDetector__isWebCached;
              if (!(t3 == null ? $.PlatformDetector__isWebCached = true : t3)) {
                t3 = t2.DioMixin__interceptors;
                t3.add$1(t3, new A.CookieManager());
              }
              t3 = t2.DioMixin___DioMixin_options_A;
              t3 === $ && A.throwLateFieldNI("options");
              t3 = t3.___RequestConfig__headers_A;
              t3 === $ && A.throwLateFieldNI("_headers");
              t3.$indexSet(0, "User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:146.0) Gecko/20100101 Firefox/146.0");
              executor0 = new A._BaixadorNfeExecutor(new A.ClienteAntiCaptcha("CHAVE_API_ANTI_CAPTCHA", t1), new A.ClienteApiNfe(t2));
              executor0.___BaixadorNfeExecutor__cacheManager_F = new A.NfeCacheManager(new A.NfeCacheStorage());
              executor = executor0;
              $async$handler = 3;
              $async$goto = 6;
              return A._asyncAwait(executor.baixarNfe$3$baixarBytes$senha$tempoLimite(baixarBytes, senha, tempoLimite), $async$call$2$baixarBytes$senha);
            case 6:
              // returning from await.
              t1 = $async$result;
              $async$returnValue = t1;
            ...
            case 4:
              ...
              $async$handler = 2;
              t1 = executor;
              t2 = t1._clienteCaptcha._dio;
              t2.DioMixin__closed = true;
              t2 = t2.DioMixin___DioMixin_httpClientAdapter_A;
              t2 === $ && A.throwLateFieldNI("httpClientAdapter");
              t2.close$1$force(true);
              t1 = t1._clienteNfe._nfe_api_client$_dio;
              t1.DioMixin__closed = true;
              t1 = t1.DioMixin___DioMixin_httpClientAdapter_A;
              t1 === $ && A.throwLateFieldNI("httpClientAdapter");
      ...
      return A._asyncStartSync($async$call$2$baixarBytes$senha, $async$completer);
    }
  };
  A._BaixadorNfeExecutor.prototype = {
    baixarNfe$3$baixarBytes$senha$tempoLimite(baixarBytes, senha, tempoLimite) {
      return this.baixarNfe$body$_BaixadorNfeExecutor(baixarBytes, senha, tempoLimite);
    },
    baixarNfe$body$_BaixadorNfeExecutor(baixarBytes, senha, tempoLimite) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, e, t1, exception, tempoLimiteEfetivo, $async$exception;
      var $async$baixarNfe$3$baixarBytes$senha$tempoLimite = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              tempoLimiteEfetivo = tempoLimite == null ? B.Duration_60000000 : tempoLimite;
              $async$handler = 4;
              t1 = type$.Map_String_dynamic;
              $async$goto = 7;
              return A._asyncAwait(A.Future_any(A._setArrayType([$async$self._baixarNfeComCache$2$baixarBytes$senha(baixarBytes, senha), A.Future_Future$delayed(tempoLimiteEfetivo, type$.dynamic).then$1$1(new A._BaixadorNfeExecutor_baixarNfe_closure(tempoLimiteEfetivo), t1)], type$.JSArray_Future_Map_String_dynamic), t1), $async$baixarNfe$3$baixarBytes$senha$tempoLimite);
            case 7:
              // returning from await.
              t1 = $async$result;
              $async$returnValue = t1;
            ...
            case 4:
              ...
              $async$exception = $async$errorStack.pop();
              e = A.unwrapException($async$exception);
              if (e instanceof A.ExcecaoNfe)
                throw $async$exception;
              throw A.wrapException(A.ExcecaoApiNfe$("Erro inesperado durante o download", null, e, null));
              // goto after finally
              $async$goto = 6;
              break;
            case 3:
      ...
      return A._asyncStartSync($async$baixarNfe$3$baixarBytes$senha$tempoLimite, $async$completer);
    },
    _baixarNfeComCache$2$baixarBytes$senha(baixarBytes, senha) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$self = this, entryCache, resultado, t1;
      var $async$_baixarNfeComCache$2$baixarBytes$senha = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.___BaixadorNfeExecutor__cacheManager_F;
              t1 === $ && A.throwLateFieldNI("_cacheManager");
              $async$goto = 3;
              return A._asyncAwait(t1.obter$1(senha), $async$_baixarNfeComCache$2$baixarBytes$senha);
            case 3:
              // returning from await.
              entryCache = $async$result;
              $async$goto = entryCache != null ? 4 : 5;
              break;
            case 4:
              // then
              $async$goto = baixarBytes && entryCache.bytesBase64 == null ? 6 : 7;
              break;
            case 6:
              // then
              $async$goto = 8;
              return A._asyncAwait($async$self._baixarNfeInterno$2$baixarBytes$senha(baixarBytes, senha), $async$_baixarNfeComCache$2$baixarBytes$senha);
            case 8:
              // returning from await.
              resultado = $async$result;
              t1.salvar$2(senha, resultado).catchError$1(new A._BaixadorNfeExecutor__baixarNfeComCache_closure());
              $async$returnValue = resultado;
              // goto return
              $async$goto = 1;
              break;
            case 7:
              // join
              $async$returnValue = entryCache.paraResultado$1$baixarBytes(baixarBytes);
              // goto return
              $async$goto = 1;
              break;
            case 5:
            ...
            case 9:
              // returning from await.
              resultado = $async$result;
              t1.salvar$2(senha, resultado).catchError$1(new A._BaixadorNfeExecutor__baixarNfeComCache_closure0());
              $async$returnValue = resultado;
              // goto return
              $async$goto = 1;
              break;
      ...
      return A._asyncStartSync($async$_baixarNfeComCache$2$baixarBytes$senha, $async$completer);
    },
    _baixarNfeInterno$2$baixarBytes$senha(baixarBytes, senha) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$self = this, bytesPdf, bytesBase64, funcaoSalvar, t1, idDocumento, $async$temp1, $async$temp2, $async$temp3;
      var $async$_baixarNfeInterno$2$baixarBytes$senha = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self._clienteNfe;
              $async$temp1 = t1;
              $async$temp2 = t1;
              $async$temp3 = senha;
              $async$goto = 5;
              return A._asyncAwait($async$self._clienteCaptcha.resolverRecaptchaV2$2$chaveSite$urlSite("6Lf9374hAAAAAMorFLzMzomJWlbu0FK92Q25culn", string$.https_), $async$_baixarNfeInterno$2$baixarBytes$senha);
            case 5:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait($async$temp2.buscarDocumento$2$senha$tokenCaptcha($async$temp3, $async$result), $async$_baixarNfeInterno$2$baixarBytes$senha);
            case 4:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait($async$temp1.obterIdDocumento$2$dadosCriptografados$senha($async$result, senha), $async$_baixarNfeInterno$2$baixarBytes$senha);
            case 3:
              // returning from await.
              idDocumento = $async$result;
              $async$goto = baixarBytes ? 6 : 8;
              break;
            case 6:
              // then
              $async$goto = 9;
              return A._asyncAwait(t1.baixarPdf$1(idDocumento), $async$_baixarNfeInterno$2$baixarBytes$senha);
            case 9:
              // returning from await.
              bytesPdf = $async$result;
              type$.Base64Codec._eval$1("Codec.S")._as(bytesPdf);
              bytesBase64 = B.C_Base64Codec.get$encoder().convert$1(bytesPdf);
              // goto join
              $async$goto = 7;
              break;
            case 8:
            ...
            case 7:
              // join
              t1 = bytesPdf == null;
              funcaoSalvar = !t1 ? new A._BaixadorNfeExecutor__baixarNfeInterno_closure(idDocumento, bytesPdf) : null;
              t1 = t1 ? null : bytesPdf.length;
              if (t1 == null)
                t1 = 0;
              $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["urlDownload", "https://www.nfe-cidades.com.br/relatorioNotaFiscal.action?id=" + idDocumento, "idDocumento", idDocumento, "tamanho", t1, "bytes", bytesPdf, "bytesBase64", bytesBase64, "salvar", funcaoSalvar], type$.String, type$.dynamic);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_baixarNfeInterno$2$baixarBytes$senha, $async$completer);
    }
  };
  A._BaixadorNfeExecutor_baixarNfe_closure.prototype = {
    call$1(__wc0_formal) {
      throw A.wrapException(A.ExcecaoTempoEsgotado$("Opera\xe7\xe3o expirou ap\xf3s " + this.tempoLimiteEfetivo.get$inSeconds() + " segundos", null, null));
    },
    $signature: 52
  };
  A._BaixadorNfeExecutor__baixarNfeComCache_closure.prototype = {
    call$1(erro) {
    },
    $signature: 4
  };
  A._BaixadorNfeExecutor__baixarNfeComCache_closure0.prototype = {
    call$1(erro) {
    },
    $signature: 4
  };
  A._BaixadorNfeExecutor__baixarNfeInterno_closure.prototype = {
    call$1$nome(nome) {
      return this.$call$body$_BaixadorNfeExecutor__baixarNfeInterno_closure(A._asStringQ(nome));
    },
    call$0() {
      return this.call$1$nome(null);
    },
    $call$body$_BaixadorNfeExecutor__baixarNfeInterno_closure(nome) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, nomeArquivo;
      var $async$call$1$nome = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              if (nome == null || nome.length === 0)
                nomeArquivo = $async$self.idDocumento + ".pdf";
              else
                nomeArquivo = !B.JSString_methods.endsWith$1(nome.toLowerCase(), ".pdf") ? nome + ".pdf" : nome;
              $async$goto = 2;
              return A._asyncAwait(A.NfeFileSaver_salvar($async$self.bytesNaoNulos, null, nomeArquivo), $async$call$1$nome);
  ...
  (function installTearOffs() {
    ...
    _instance_2_u(_, "get$_onError", "_onError$2", 2);
    ...
    _static_1(A, "convert___defaultToEncodable$closure", "_defaultToEncodable", 25);
    ...
    _instance_2_u(_ = A.Interceptor0.prototype, "get$onRequest", "onRequest$2", 9);
    _instance_2_u(_, "get$onResponse", "onResponse$2", 19);
    _instance_2_u(_, "get$onError", "onError$2", 20);
    _instance_2_u(A.ImplyContentTypeInterceptor.prototype, "get$onRequest", "onRequest$2", 9);
    _static_1(A, "options___defaultValidateStatus$closure", "_defaultValidateStatus", 5);
    _static_1(A, "fused_transformer_FusedTransformer__decodeUtf8ToJson$closure", "FusedTransformer__decodeUtf8ToJson", 69);
    _static_1(A, "case_insensitive_map_CaseInsensitiveMap__canonicalizer$closure", "CaseInsensitiveMap__canonicalizer", 14);
    _instance_2_u(_ = A.CookieManager.prototype, "get$onRequest", "onRequest$2", 9);
    _instance_2_u(_, "get$onResponse", "onResponse$2", 19);
    _instance_2_u(_, "get$onError", "onError$2", 20);
    _static(A, "math__max$closure", 2, null, ["call$1$2", "call$2"], ["max", function(a, b) {
      return A.max(a, b, type$.num);
    }], 51, 0);
    _static(A, "compute_impl__compute$closure", 2, null, ["call$2$3$debugLabel", "call$2", "call$2$2"], ["compute", function(callback, message) {
      var t1 = type$.dynamic;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A._BytesBuilder, A.Error, A.ListBase, A.Closure, A.SentinelValue, A.Iterable, A.ListIterator, A.WhereIterator, A.ExpandIterator, A.SkipIterator, A.EmptyIterator, A.WhereTypeIterator, A.FixedLengthListMixin, A.UnmodifiableListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapValueIterator, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._AllMatchesIterator, A.StringMatch, A._StringAllMatchesIterator, A._Cell, A._UnmodifiableNativeByteBufferView, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamTransformerBase, A._StreamController, A._AsyncStreamControllerDispatch, A._BufferingStreamSubscription, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._StreamIterator, A._EventSinkWrapper, A._HandlerEventSink, A._Zone, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A._UnmodifiableMapMixin, A.MapView, A.StringConversionSink, A.Codec, A.Converter, A._Base64Encoder, A.ByteConversionSink, A._Base64Decoder, A.ChunkedConversionSink, A._ConverterStreamEventSink, A._JsonStringifier, A._ClosableStringSink, A._StringConversionSinkAsStringSinkAdapter, A._Utf8Encoder, A._Utf8Decoder, A._WeakReferenceWrapper, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.Stopwatch, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.CancelableOperation, A.CancelableCompleter, A.CanonicalizedMap, A.ResponseBody, A.DioException, A.DioMixin, A.InterceptorState, A._BaseHandler, A.Interceptor0, A.Headers, A.OptionsMixin, A._RequestConfig, A.Options, A.Response, A.Transformer, A._DefaultIfEmptyStreamSink, A.BrowserHttpClientAdapter, A._DioForBrowser_Object_DioMixin, A.MediaType, A.ClienteAntiCaptcha, A.NfeCacheManager, A.NfeCacheEntry, A.NfeCacheStorage, A.SharedPreferences, A.ExcecaoNfe, A.RequisicaoCriarTarefaAntiCaptcha, A.TarefaRecaptchaV2SemProxy, A.RespostaCriarTarefaAntiCaptcha, A.RequisicaoObterResultadoAntiCaptcha, A.RespostaObterResultadoAntiCaptcha, A.ClienteApiNfe, A.BaixadorNfeCidades, A._BaixadorNfeExecutor, A.Context, A.Style, A.ParsedPath, A.PathException, A.SourceFile, A.SourceLocationMixin, A.SourceSpanMixin, A.Highlighter, A._Highlight, A._Line, A.SourceLocation, A.SourceSpanException, A.StringScanner, A.EventStreamProvider, A._EventStreamSubscription]);
    ...
    _inheritMany(A.Stream, [A._StreamImpl, A._MultiStream, A._BoundSinkStream, A._EventStream]);
    ...
    _inheritMany(A.StreamTransformerBase, [A._StreamSinkTransformer, A.DefaultNullIfEmptyStreamTransformer]);
    ...
    _inheritMany(A.Interceptor0, [A.ImplyContentTypeInterceptor, A.CookieManager]);
    ...
    _inheritMany(A.ExcecaoNfe, [A.ExcecaoAntiCaptcha, A.ExcecaoTempoEsgotadoCaptcha, A.ExcecaoApiNfe, A.ExcecaoRede, A.ExcecaoTempoEsgotado]);
    _inheritMany(A.ExcecaoApiNfe, [A.ExcecaoDocumentoNaoEncontrado, A.ExcecaoSenhaInvalida]);
  ...
  var string$ = {
    ...
    x20or_im: " or improve the response time of the server.",
    ...
    https_: "https://www.nfe-cidades.com.br/landing-page",
    text_h: "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"
  };
  var type$ = (function rtii() {
    ...
    return {
      ...
      ErrorInterceptorHandler: findType("ErrorInterceptorHandler"),
      ...
      JSArray_Future_Map_String_dynamic: findType("JSArray<Future<Map<String,@>>>"),
      JSArray_Future_nullable_Object: findType("JSArray<Future<Object?>>"),
      ...
      ResponseInterceptorHandler: findType("ResponseInterceptorHandler"),
      Response_dynamic: findType("Response<@>"),
      RespostaObterResultadoAntiCaptcha: findType("RespostaObterResultadoAntiCaptcha"),
      ...
      _BoundSinkStream_dynamic_Uint8List: findType("_BoundSinkStream<@,Uint8List>"),
      ...
      nullable_Future_void_Function_$named_nome_nullable_String: findType("Future<~>({nome:String?})?"),
      nullable_JSObject: findType("JSObject?"),
      nullable_List_dynamic: findType("List<@>?"),
      nullable_Map_String_dynamic: findType("Map<String,@>?"),
      nullable_NfeCacheEntry: findType("NfeCacheEntry?"),
      ...
      nullable_nullable_Object_Function_nullable_Object: findType("Object?(Object?)?"),
  ...
  (function constants() {
    ...
    B.C_BaixadorNfeCidades = new A.BaixadorNfeCidades();
    B.C_Base64Encoder = new A.Base64Encoder();
    B.C_Base64Codec = new A.Base64Codec();
    B.C_Base64Decoder = new A.Base64Decoder();
    B.C_DefaultNullIfEmptyStreamTransformer = new A.DefaultNullIfEmptyStreamTransformer();
...
;
    ...
    B.DioExceptionType_0 = new A.DioExceptionType(0, "connectionTimeout");
    B.DioExceptionType_2 = new A.DioExceptionType(2, "receiveTimeout");
    B.DioExceptionType_4 = new A.DioExceptionType(4, "badResponse");
    B.DioExceptionType_5 = new A.DioExceptionType(5, "cancel");
    B.DioExceptionType_6 = new A.DioExceptionType(6, "connectionError");
    B.DioExceptionType_7 = new A.DioExceptionType(7, "unknown");
    ...
    B.ExcecaoAntiCaptcha_0mq = new A.ExcecaoAntiCaptcha(null, "Nenhum ID de tarefa retornado do Anti-Captcha", null);
    B.ExcecaoApiNfe_LJl = new A.ExcecaoApiNfe(null, "Resposta inv\xe1lida de buscarDocumento: dados da resposta s\xe3o nulos", null);
    B.ExcecaoApiNfe_QW4 = new A.ExcecaoApiNfe(null, "N\xe3o foi poss\xedvel extrair o ID do documento da resposta", null);
    B.ExcecaoApiNfe_TN1 = new A.ExcecaoApiNfe(null, "Resposta inv\xe1lida de buscarDocumento: dados da resposta est\xe3o vazios", null);
    B.InterceptorResultType_0 = new A.InterceptorResultType(0, "next");
    B.InterceptorResultType_1 = new A.InterceptorResultType(1, "resolve");
    B.InterceptorResultType_2 = new A.InterceptorResultType(2, "resolveCallFollowing");
    B.InterceptorResultType_4 = new A.InterceptorResultType(4, "rejectCallFollowing");
    B.JsonDecoder_null = new A.JsonDecoder(null);
    B.JsonEncoder_null = new A.JsonEncoder(null);
    B.ListFormat_4 = new A.ListFormat(4, "multi");
    B.ListFormat_5 = new A.ListFormat(5, "multiCompatible");
    B.List_110_117_108_108 = makeConstList([110, 117, 108, 108], type$.JSArray_int);
    B.List_empty2 = makeConstList([], A.findType("JSArray<Interceptor0>"));
    B.List_empty = makeConstList([], type$.JSArray_RedirectRecord);
    B.List_empty1 = makeConstList([], type$.JSArray_String);
    B.List_empty0 = makeConstList([], type$.JSArray_int);
    B.ResponseType_0 = new A.ResponseType(0, "json");
    B.ResponseType_1 = new A.ResponseType(1, "stream");
    B.ResponseType_2 = new A.ResponseType(2, "plain");
    B.ResponseType_3 = new A.ResponseType(3, "bytes");
  ...
  (function staticFields() {
    ...
    $.SharedPreferences__instance = null;
    $.PlatformDetector__isWebCached = null;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_DefaultIfEmptyStreamSink__nullUtf8Value", "$get$_DefaultIfEmptyStreamSink__nullUtf8Value", () => A.NativeUint8List_NativeUint8List$fromList(B.List_110_117_108_108));
