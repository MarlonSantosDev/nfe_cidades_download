...
class NfeConstants {
  ...
  static const antiCaptchaCreateTaskUrl = 'https://api.anti-captcha.com/createTask';
  static const antiCaptchaGetResultUrl = 'https://api.anti-captcha.com/getTaskResult';

  // NFe-Cidades endpoints
  static const nfeBaseUrl = 'https://www.nfe-cidades.com.br';
  static const nfeBuscarDocumentoUrl = '$nfeBaseUrl/v2/rest/public/login/buscarDocumento';
  ...
  // HTTP headers
  static const userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:146.0) Gecko/20100101 Firefox/146.0';
