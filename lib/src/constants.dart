...
class ConstantesNfe {
  ...
  static const urlCriarTarefaAntiCaptcha = 'https://api.anti-captcha.com/createTask';
  
  /// Endpoint da API Anti-Captcha para recuperar resultados de tarefas
  static const urlObterResultadoAntiCaptcha = 'https://api.anti-captcha.com/getTaskResult';
  ...
  static const urlBuscarDocumentoNfe = '$urlBaseNfe/v2/rest/public/login/buscarDocumento';
  ...
  static const agenteUsuario = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:146.0) Gecko/20100101 Firefox/146.0';
